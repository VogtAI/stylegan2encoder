...
class PerceptualModel:
    def __init__(self, args, batch_size=1, perc_model=None, sess=None):
        ...
        self.background_color = list(map(int, args.background_color))
    ...
    def build_perceptual_model(self, generator, discriminator=None):
        ...
        if (self.background_loss is not None):
            ...
            if self.adaptive_loss:
                ...
                self.loss += self.background_loss * tf_custom_logcosh_loss(self.ref_background_weight * green_img, self.ref_background_weight * generated_image)
